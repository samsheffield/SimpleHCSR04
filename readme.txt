...
A simple interface to the HC-SR04 "Ping" sensor that returns distance data in raw or converted (inches and centimeters) values. No more, no less. Based off the example from here: http://www.instructables.com/id/Simple-Arduino-and-HC-SR04-Example/
